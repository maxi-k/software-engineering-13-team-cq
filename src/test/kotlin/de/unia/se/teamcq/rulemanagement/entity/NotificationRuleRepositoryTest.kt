...
class NotificationRuleRepositoryTest : StringSpec() {
    ...
    init {
        ...
        val notificationRuleModel = getTestNotificationRuleModel()
        ...
        "getAllNotificationRulesForUser should work" {
            ...
            val expextedNotificationRule = notificationRuleModel.copy().apply {
                owner!!.name = "test1"
        ...
        "createNotificationRule should work" {
            ...
            val savedNotificationRule = notificationRuleRepository.createNotificationRule(notificationRuleModel)

            savedNotificationRule shouldBe notificationRuleModel
        }
        ...
        "updateNotificationRule should work and not overwrite user" {
            ...
            val newNotificationRuleWithNewUser = notificationRuleModel.apply {
                description = "new"
                owner = newUser
            }
