...
object JwtTestConfig {
    ...
    val expiration: Int = 24 * 60 * 60

    val publicKey: String = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAyFa0WF36CXzu6xU7tNk5" +
    ...
    val privateKey: String = "MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQDIVrRYXfoJfO7r" +
