...
import { LangSwitch } from 'src/i18n/components/lang-switch/lang-switch.container.component';
import { lightgray, white } from 'src/shared/styles/variables';
import { media, sizes } from 'src/utils/media-query';
